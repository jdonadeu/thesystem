...
class getDoctrine_Orm_DefaultConfigurationService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $instance->setRepositoryFactory(new \Doctrine\Bundle\DoctrineBundle\Repository\ContainerRepositoryFactory(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService ??= $container->getService(...), [
            'App\\Repository\\ForebetOptimalValuesRepository' => ['privates', 'App\\Repository\\ForebetOptimalValuesRepository', 'getForebetOptimalValuesRepositoryService', true],
            'App\\Repository\\ForebetRepository' => ['privates', 'App\\Repository\\ForebetRepository', 'getForebetRepositoryService', true],
            'App\\Repository\\TodayFootballPredictionRepository' => ['privates', 'App\\Repository\\TodayFootballPredictionRepository', 'getTodayFootballPredictionRepositoryService', true],
        ], [
            'App\\Repository\\ForebetOptimalValuesRepository' => '?',
            'App\\Repository\\ForebetRepository' => '?',
            'App\\Repository\\TodayFootballPredictionRepository' => '?',
        ])));
